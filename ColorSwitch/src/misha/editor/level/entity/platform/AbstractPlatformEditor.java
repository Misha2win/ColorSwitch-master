...
public abstract class AbstractPlatformEditor<T extends Platform> extends EntityEditor<T> {
	
	protected Rectangle rectangle;
	
	public AbstractPlatformEditor(LevelEditor levelEditor) {
		this(levelEditor, null);
	}
	
	public AbstractPlatformEditor(LevelEditor levelEditor, T platform) {
